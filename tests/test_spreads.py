...
class SpreadTest(FreshersTest):
    ...
    def test_TextFrame(self):
        ...
        self.assertElement(element, 'TextFrame',
            Self="u14d2",
            ParentStory__Self="u14d5",
            PreviousTextFrame="n",
            NextTextFrame="n",
            ContentType="TextType",
            AppliedObjectStyle__Self="ObjectStyle/News text box", 
    ...
    def test_Rectangle(self):
        ...
        self.assertElement(element, 'Rectangle',
            ...
            AppliedObjectStyle__Self="ObjectStyle/Dividing line",
            FillTint=9,
            StrokeWeight=0,
    ...
    def test_Image(self):
        ...
        self.assertElement(element, 'Image',
            ...
            AppliedObjectStyle__Self="ObjectStyle/$ID/[None]", 
            LocalDisplaySetting="Default",
